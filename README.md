...
| Сортировка строк по колонке | Не заявлена | Есть, включая автоопределение числовых колонок |
| Конвертация CSV/TSV в таблицу | Не заявлена | Есть |
| Вставка новой таблицы по размеру | Не заявлена | Есть |
...
Smoke-тесты проверяют выравнивание, навигацию по ячейкам, операции со строками и колонками, escaped pipes, таблицы без внешнего `|`, UTF-8/CJK-ширину и защиту от некорректного удаления строк.
